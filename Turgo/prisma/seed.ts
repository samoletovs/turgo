  ...
  for (const l of allListings) {
    const listing = await prisma.listing.upsert({
      ...
      update: {
        ...
        negotiable:
          (l as unknown as Record<string, boolean>).negotiable ?? true,
        status: "ACTIVE",
      },
      create: {
        title: l.title,
    ...
    if (
      (l as unknown as Record<string, unknown>).attrs &&
      l.categoryId === carsCatRec.id
    ) {
      const attrs = (l as unknown as Record<string, Record<string, string>>)
        .attrs;
