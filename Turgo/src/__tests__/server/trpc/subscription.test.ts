...
describe("cancel", () => {
  ...
  it("throws when no active subscription", async () => {
    ...
    await expect(authedCaller().cancel()).rejects.toThrow(
...
describe("resume", () => {
  ...
  it("throws when no cancelled subscription to resume", async () => {
    ...
    await expect(authedCaller().resume()).rejects.toThrow(
      "No cancelled subscription to resume",
    );
  });
...
describe("createPortalSession", () => {
  ...
  it("throws when no billing account", async () => {
    ...
    await expect(authedCaller().createPortalSession()).rejects.toThrow(
