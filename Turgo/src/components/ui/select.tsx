...
/* Radix generates random IDs (aria-controls) that differ between SSR and
   client, causing hydration mismatches.  We defer rendering until the
   component has mounted so IDs are only ever created on the client. */
