...
async function main() {
  ...
  const locations: {
    ...
    children?: {
      ...
      slug: string;
      type: 'REGION' | 'CITY';
      children?: { name: LocName; slug: string; type: 'CITY' }[];
    }[];
  }[] = [
    {
      name: {
  ...
  async function seedLocation(loc: (typeof locations)[number], parentId: string | null = null) {
  ...
  const aptSaleCat = await prisma.category.findUnique({
    where: { slug: 'apartments-sale' },
  });
  if (aptSaleCat) {
    await prisma.categoryAttribute.deleteMany({
      where: { categoryId: aptSaleCat.id },
    });
    ...
    const aptAttributes = [
      ...
      },
      {
        ...
        type: 'SELECT' as const,
        options: ['New Project', 'Renovated', 'Soviet Brick', 'Soviet Panel', 'Pre-war', 'Wooden'],
        isRequired: false,
      },
  ...
  const phonesCat = await prisma.category.findUnique({
    where: { slug: 'phones-tablets' },
  });
  if (phonesCat) {
    await prisma.categoryAttribute.deleteMany({
      where: { categoryId: phonesCat.id },
    });
  ...
  const testUsers = [
    ...
    {
      email: 'giedre@test.lt',
      name: 'Giedrė Jonaitienė',
      phone: '+37060000002',
      locale: 'lt',
    },
    {
    ...
    {
      email: 'katrin@test.ee',
      name: 'Katrin Saar',
      phone: '+37250000002',
      locale: 'et',
    },
    {
      email: 'dmitrij@test.lv',
      name: 'Дмитрий Иванов',
      phone: '+37120000006',
      locale: 'ru',
    },
  ...
  const carListings = [
    {
      ...
      description:
        'BMW 520d xDrive Luxury Line. Automātiskā ārumsārba, ādas salons, navigācija, LED lukturi, apkurināmi sēdekļi, atpakaļskata kamera. Pilna servisa vēsture pie oficiālā dīlera. Viens īpašnieks. Tehniskā apskate līdz 2027. gadam.',
      price: 32500,
    ...
    },
    {
      ...
      slug: 'vw-golf-8-2021',
      description:
        'VW Golf 8 Style 1.5 TSI. Digitālā mērinstrumentu panelis, adaptīvais kruīza kontrole, Lane Assist, Park Assist, LED Matrix lukturi. Gaišs salons, lieliski uzturēts. Nopērkams arī līzingā.',
      price: 24900,
      condition: 'USED' as const,
    ...
    },
    {
      ...
      description:
        'Audi A4 Avant S-line pakotne. Virtuālais kokpits, MMI navigācija, B&O skaņas sistēma, panorāmas jumts, elektriskais aizmugurējais vāks. Serviss pie Moller Auto. Ziemas riepas komplektā.',
      price: 19800,
      condition: 'USED' as const,
    ...
    },
    {
      ...
      description:
        'Toyota RAV4 2.5 Hybrid AWD. Pilna komplektācija, ādas salons, JBL skaňas sistēma, panorāma jumts, apkurināmi sēdekļi un stūre. Garantija līdz 2027. gadam. Viens īpašnieks.',
      price: 38500,
      condition: 'USED' as const,
    ...
    },
    {
      ...
      description:
        'Opel Astra K 1.6 CDTI 110 ZS. Ekonomisks dīzelis, kruīza kontrole, multifunkcionālā stūre, Bluetooth, kondicionieris. Labs stāvoklis, regulāri apkopota. Cena nedaudz runājama.',
      price: 8900,
      condition: 'USED' as const,
    ...
    },
    {
      ...
      description:
        'Mercedes-Benz C220d 4MATIC, AMG pakett, kõigi rataste vedamine. Nahksisu, MBUX multimeedia, 360° kaamera, ambient-valgustus, Burmester helikaart. Hooldatud ametlikus teeninduses.',
      price: 35900,
      condition: 'USED' as const,
  ...
  const aptListings = [
    {
      ...
      description:
        'Pārdod pilnīgi renovētu 3-istabu dzīvokli Rīgas centrā, Quiet centrā. Kvalitatīvs remonts 2023. gadā: jauna virtuve, vannas istaba, parkets. Liels balkons ar skatu uz pilsētu. Iebūvēta virtuve ar Bosch tehniku. Apkurināmas grīdas vannas istabā.',
      price: 185000,
      condition: 'USED' as const,
    ...
    },
    {
      ...
      description:
        "Pārdod 2-istabu dzīvokli jaunajā projektā 'Mārupe Gardens'. Augsta kvalitāte: trīskāršie stikli, silts modulis, A enerģijas klase. Autostāvvieta pazemes garāžā iekļauta cenā. Pieejams no 2026. gada marta.",
      price: 142000,
    ...
    },
    {
      ...
      description:
        'Parduodamas jaukus 1 kambario butas Vilniaus senamiestyje. Visiškai suremontuotas, baldai įskaičiuoti į kainą. Šildymas dujomis, žemi komunaliniai mokesčiai. Rajonas ramus, šalia visa infrastruktūra. Puiki investicija nuomai.',
      price: 115000,
      condition: 'USED' as const,
      userId: userRecords['jonas@test.lt'].id,
      locationId: vilniusLoc.id,
    ...
    },
    {
      ...
      description:
        'Müüa renoveeritud 2-toaline korter Tallinna kesklinnas. Uus köök, vannituba, parkett. Rõdu linnavaatega. Soe korter, head ühistranspordi ühendused. Parkimiskoht hoovis.',
      price: 195000,
      condition: 'USED' as const,
    ...
    },
    {
      ...
      description:
        'Izīrē mēbelētu 2-istabu dzīvokli klusā Āgenskalna ielā. Remonts 2024. gadā, pilnībā mēbelēts, veļasmašīna, trauku mazgājamā mašīna. Komunālie ~120 EUR/mēn. Pieejams no marta.',
      price: 550,
      condition: 'USED' as const,
      userId: userRecords['maris@test.lv'].id,
      locationId: rigaLoc.id,
  ...
  const electronicsListings = [
    {
      ...
      description:
        'Pārdodu iPhone 15 Pro Max 256GB Natural Titanium. Lietots 6 mēnešus, perfektā stāvoklī, bez skrāpējumiem. Komplektā: oriģinālā kaste, kabelis, aizsargstikls jau uzlikts. Akumulatora veselība 98%. Garantija līdz 2027. gadam.',
      price: 950,
      condition: 'USED' as const,
      userId: userRecords['anna@test.lv'].id,
      locationId: rigaLoc.id,
    ...
    },
    {
      ...
      description:
        'Samsung Galaxy S24 Ultra, 512GB, Titanium Gray. Naudotas 3 mėnesius, idealios būklės. S Pen, originali dėžutė ir pakrovėjas. Galaxy AI funkcijos. Ekrano apsauga ir dėklas pridedami nemokamai.',
      price: 1050,
      condition: 'USED' as const,
    ...
    },
    {
      ...
      description:
        'Apple MacBook Pro 14 collas ar M3 Pro čipu, 18GB RAM, 512GB SSD. Space Black krāsa. Pirkts 2024. gada oktobrī Apple veikalā. Akumulatora ciklu skaits: 45. Perfekts stāvoklis, komplektā lādētājs un kaste.',
      price: 1750,
      condition: 'USED' as const,
      userId: userRecords['janis@test.lv'].id,
      locationId: rigaLoc.id,
    ...
    },
    {
      ...
      description:
        'Lenovo ThinkPad X1 Carbon Gen 11. Intel Core i7-1365U, 32GB RAM, 1TB SSD, 14" 2.8K OLED ekrāns. Izcils biznesa klases portatīvais dators. Ideāls attālinātam darbam. Komplektā docking station.',
      price: 1200,
      condition: 'USED' as const,
      userId: userRecords['mart@test.ee'].id,
    ...
    },
    {
      ...
      description:
        'Pārdodu PlayStation 5 Disc Edition komplektu. Iekļauts: 2x DualSense kontrolieri (balts + melns), 5 spēles (Spider-Man 2, God of War Ragnarök, Horizon Forbidden West, Gran Turismo 7, FC 25). Viss labā stāvoklī. Čeks pieejams.',
      price: 420,
      condition: 'USED' as const,
      userId: userRecords['andris@test.lv'].id,
      locationId: rigaLoc.id,
  ...
  const homeListings = [
    {
      ...
      description:
        'Pārdodu IKEA SÖDERHAMN stūra dīvānu, 3+1. Pelēka Samsta krāsa. Iegādāts 2023. gadā, ļoti labs stāvoklis. Noņemami un mazgājami pārvalki. Ir arī papildu atzveltņu komplekts. Jāizved pašam. Centra+ rajons.',
      price: 650,
      condition: 'USED' as const,
      userId: userRecords['liga@test.lv'].id,
      locationId: rigaLoc.id,
    ...
    },
    {
      ...
      description:
        'Bosch WAU28P40 veļasmašīna, 9kg ietilpība, 1400 apgr/min. A+++ energoklase, ļoti klusa darbība. Anti-vibration dizains. Lietota 2 gadus, darbojas nevainojami. Pārdodu sakarā ar pārcelšanos.',
      price: 350,
      condition: 'USED' as const,
      userId: userRecords['anna@test.lv'].id,
      locationId: rigaLoc.id,
    ...
    },
    {
      ...
      description:
        'Makita DDF484RTJ 18V LXT akumulatora urbis-skrūvgriezis. Komplektā 2x 5.0Ah akumulatori, lādētājs, MAKPAC koferis. Bezotas motors, 54Nm griezes moments. Mazlietots, kā jauns.',
      price: 185,
      condition: 'USED' as const,
      userId: userRecords['andris@test.lv'].id,
      locationId: jelgavaLoc.id,
  ...
  const sportsListings = [
    {
      ...
      description:
        'Pārdodu mājas trenažieru komplektu: regulējams sols, olimpiskais stienis 20kg, svaru diski (2x20kg, 2x10kg, 2x5kg, 4x2.5kg). Kopā 95kg svaru. Lieliski piemērots mājas treniňiem. Var apskatīt Jūrmalā.',
      price: 280,
      condition: 'USED' as const,
      userId: userRecords['janis@test.lv'].id,
      locationId: jurmalaLoc.id,
    ...
    },
    {
      ...
      description:
        'Pārdodu e-velosipēdu Cube Reaction Hybrid Pro 625 Wh, 2024. gada modelis, L izmērs. Bosch Performance CX motors. Nobraukums ~800 km. Shimano Deore XT pārslēgi. Ideāls pilsētas un meža braucieniem.',
      price: 2800,
      condition: 'USED' as const,
      userId: userRecords['mart@test.ee'].id,
      locationId: tallinnLoc.id,
  ...
  const fashionListings = [
    {
      ...
      description:
        'Max Mara 101801 ikona mētelis, 100% kamieļvilna. Izmērs M (IT 42). Kamelkrāsa. Nēsāts vienu sezonu, perfekts stāvoklis. Oriģinālā cena €1,800. Iekļauts apģērbu maisiņš.',
      price: 750,
      condition: 'USED' as const,
      userId: userRecords['liga@test.lv'].id,
      locationId: rigaLoc.id,
    ...
    },
    {
      ...
      description:
        'Jauni Nike Air Max 90 Essential, White/Black colorway. Izmērs EUR 43 (US 9.5). Oriģināli, pasūtīti no Nike.com, izrādījās par mazu. Kaste un čeks iekļauti. Cena nav runājama.',
      price: 95,
      condition: 'NEW' as const,
      userId: userRecords['maris@test.lv'].id,
      locationId: rigaLoc.id,
  ...
  const petListings = [
    {
      ...
      description:
        'Piedāvājam brīnišķīgus Labradoru retrīveru kucēnus. Dzimšanas datums: 2026. gada 5. janvāris. Šokoladkrāsas un melnā krāsā. Čipēti, vakcinēti, ar ciltsrakstiem (LKF). Vecāki pārbaudīti uz pārmantotajām slimībām. Gatavi jaunajām mājām no 8 marta.',
      price: 1200,
      condition: 'NEW' as const,
      userId: userRecords['giedre@test.lt'].id,
      locationId: kaunasLoc.id,
      ...
      contactPhone: '+37060000002',
      images: ['https://images.unsplash.com/photo-1591769225440-811ad7d6eab3?w=800'],
    },
  ];
  ...
  const hobbyListings = [
    {
      ...
      description:
        'Yamaha C40 klasiskā ģitāra, ideāla iesācējiem un vidējā līmeňa spēlētājiem. Ļoti labs skanējums, stīgas nomainītas pirms mēneša. Komplektā mīkstā soma un tūneris. Viss ieliokts stāvoklī.',
      price: 85,
      condition: 'USED' as const,
      userId: userRecords['dmitrij@test.lv'].id,
      locationId: rigaLoc.id,
  ...
  const houseListings = [
    {
      ...
      description:
        'Pārdod modernu privātmāju Jūrmalā, Dzintaros, 500m no jūras. 220 m² dzīvošanas platība, 3 stāvi, 5 istabas, 2 vannas istabas, sauna, garāža 2 auto. Zemes gabals 1200 m². Pilnībā renovēta 2022. gadā. Gāzes apkure, silts māja – zemi komunālie.',
      price: 420000,
      condition: 'USED' as const,
      userId: userRecords['anna@test.lv'].id,
      locationId: jurmalaLoc.id,
  ...
  const agriListings = [
    {
      ...
      description:
        'John Deere 6130R, 130 ZS, 2018. gads, 3200 motostundas. AutoQuad Plus transmisija, priekšas iekrāvējs 623R, klimata kontrole, GPS sagatavots. Regulāri apkopots pie oficiālā dīlera. Var apskatīt Jelgavas novadā.',
      price: 72000,
      condition: 'USED' as const,
      userId: userRecords['andris@test.lv'].id,
      locationId: jelgavaLoc.id,
      ...
      contactPhone: '+37120000005',
      images: ['https://images.unsplash.com/photo-1530267981375-f0de937f5f13?w=800'],
    },
  ];
