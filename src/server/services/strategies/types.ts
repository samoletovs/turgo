...
import type { SellingStrategyId, BuyingStrategyId, OfferStatus } from '@prisma/client';
...
export interface SellingStrategy {
   ...
   */
  processOffer(agent: SellingAgentContext, offer: OfferContext): Promise<SellingStrategyResult>;
   ...
   */
  getSellerView(agent: SellingAgentContext, offers: OfferContext[]): SellerOfferView[];
