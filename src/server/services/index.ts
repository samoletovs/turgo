...
export { calculateOptimalPrice, generateAutoResponse, shouldAdjustPrice } from './agent-selling';
...
// View counter
export { incrementViewCount, getViewCount, flushViewCounts } from './view-counter';
