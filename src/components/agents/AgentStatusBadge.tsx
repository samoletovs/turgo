...
type AgentStatus = 'ACTIVE' | 'PAUSED' | 'COMPLETED' | 'CANCELLED' | 'NEEDS_ATTENTION';
...
> = {
  ACTIVE: {
    variant: 'success',
    classes: 'animate-pulse bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300',
  },
  PAUSED: {
    variant: 'secondary',
  ...
  NEEDS_ATTENTION: {
    variant: 'destructive',
    classes: 'animate-pulse bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300',
  },
};
