  ...
  return (
    <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-3 text-sm dark:border-blue-800 dark:bg-blue-950/30">
      ...
      <div className="mb-2 flex items-center gap-2">
        ...
        <span className="font-medium text-blue-900 dark:text-blue-100">Market Analysis</span>
      ...
      <div className="mb-2 grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-muted-foreground">
        ...
        <div className="flex items-center gap-1">
          ...
          <span>
            Median:{' '}
            <span className="font-medium text-foreground">€{context.medianPrice.toFixed(0)}</span>
          </span>
        </div>
        <div className="flex items-center gap-1">
          <span>📐</span>
        ...
        {context.avgDaysToSell !== null && (
          <div className="flex items-center gap-1">
            ...
            <span>
              Avg time:{' '}
              <span className="font-medium text-foreground">{context.avgDaysToSell}d</span>
            </span>
          </div>
        )}
      </div>
      ...
      {/* Recommendation */}
      {reasoning && (
        <p className="mt-1 text-xs leading-relaxed text-blue-800 dark:text-blue-200">{reasoning}</p>
      )}
