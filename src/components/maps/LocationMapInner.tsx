...
export default function LocationMapInner({
  ...
  useEffect(() => {
    ...
    L.marker([latitude, longitude], { icon: defaultIcon }).addTo(map).bindPopup(markerLabel);
  ...
  return <div ref={containerRef} className="h-full w-full rounded-xl" style={{ minHeight: 300 }} />;
}
