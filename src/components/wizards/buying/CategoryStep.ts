...
export async function handleCategoryInput(content: string, ctx: BuyingStepContext) {
...
export async function handleCategoryAction(value: string, ctx: BuyingStepContext) {
