...
export async function handlePhotoUpload(e: ChangeEvent<HTMLInputElement>, ctx: SellingStepContext) {
  ...
  ctx.addUserMessage(`Uploaded ${files.length} photo${files.length > 1 ? 's' : ''}`);
...
export async function handleGreetingInput(content: string, ctx: SellingStepContext) {
...
export async function handleConfirmDetailsInput(content: string, ctx: SellingStepContext) {
