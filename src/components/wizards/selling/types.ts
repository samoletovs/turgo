...
export const SELLING_STEP_LABELS = ['photos', 'details', 'pricing', 'agent', 'launch'] as const;
...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  jobs: ['job', 'work', 'hiring', 'vacancy', 'position', 'salary', 'employment'],
  services: [
    'repair',
    'service',
    'cleaning',
  ...
  'kids-baby': ['baby', 'child', 'kids', 'stroller', 'toy', 'school', 'diaper', 'crib'],
  'sports-outdoors': [
    'sport',
    'fitness',
    'gym',
  ...
  pets: ['dog', 'cat', 'bird', 'fish', 'aquarium', 'pet', 'puppy', 'kitten', 'parrot', 'hamster'],
  'hobbies-leisure': [
    'book',
    'music',
    'guitar',
  ...
  agriculture: ['tractor', 'farm', 'seed', 'harvest', 'livestock', 'animal feed', 'agricultural'],
};
...
export interface SellingStepContext {
  ...
  addAgentMessage: (content: string, actions?: ChatAction[], component?: ReactNode) => void;
