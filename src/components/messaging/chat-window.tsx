...
export function ChatWindow({ conversationId, locale = 'en' }: ChatWindowProps) {
  ...
  const otherUser =
    conversation && userId === conversation.buyerId ? conversation.seller : conversation?.buyer;
      ...
      <div className="flex items-center gap-3 border-b px-4 py-3">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground truncate">
            Re: {conversation.listing.title} — {conversation.listing.currency === 'EUR' ? '€' : ''}
        ...
        {conversation.listing.images[0] && (
          ...
          <img
            src={conversation.listing.images[0].thumbnailUrl || conversation.listing.images[0].url}
      ...
      >
        ...
        {allMessages.map((msg) => (
          <MessageBubble
            ...
            translatedContent={msg.translatedContent as Record<string, string> | undefined}
