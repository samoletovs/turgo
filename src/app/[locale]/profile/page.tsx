...
import { User, Mail, Calendar, Settings, Package, Heart, Bot, CreditCard } from 'lucide-react';
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              {user.subscription?.plan && (
                <Badge
                  className="mt-2"
                  variant={user.subscription.plan.name === 'FREE' ? 'secondary' : 'default'}
                >
          ...
          <Card>
            <CardContent className="grid grid-cols-2 gap-4 pt-6">
              ...
              >
                ...
                <span className="text-lg font-bold">{user.subscription?.plan?.name || 'Free'}</span>
          ...
          {listings.length === 0 ? (
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">Start selling by posting your first listing</p>
                <Link href="/sell">
                ...
                <ListingCard
                  ...
                  listing={{
                    ...
                    isFeatured: listing.boosts.some(
                      (b: (typeof listing.boosts)[number]) => b.type === 'FEATURED',
                    ),
                    hasAgent: false,
                    slug: listing.slug,
                  }}
