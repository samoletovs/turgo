    ...
    <div className="py-16">
      ...
      <section className="mx-auto max-w-4xl px-4 mt-16">
        <div className="rounded-2xl border bg-card p-8 md:p-12">
          ...
          <p className="text-muted-foreground leading-relaxed text-lg">{t('mission.desc')}</p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 mt-16">
        ...
        <p className="text-muted-foreground leading-relaxed mb-6">{t('market.desc')}</p>
        <div className="grid gap-4 sm:grid-cols-3">
          {(['latvia', 'lithuania', 'estonia'] as const).map((country) => (
            <div key={country} className="rounded-xl border p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">{t(`market.${country}.desc`)}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Technology */}
      <section className="mx-auto max-w-4xl px-4 mt-16">
        <h2 className="text-2xl font-bold mb-8 text-center">{t('tech.title')}</h2>
        <div className="grid gap-6 sm:grid-cols-2">
      ...
      <section className="mx-auto max-w-4xl px-4 mt-16">
        ...
        <p className="text-muted-foreground leading-relaxed">{t('team.desc')}</p>
      </section>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <a href="mailto:hello@turgo.io" className="text-sm text-primary hover:underline">
                hello@turgo.io
              </a>
            </div>
          </div>
          ...
          <div className="rounded-xl border p-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold mb-1">{t('contact.careersLabel')}</h3>
              <a href="mailto:careers@turgo.io" className="text-sm text-primary hover:underline">
                careers@turgo.io
              </a>
            </div>
          </div>
          <div className="rounded-xl border p-6 flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold mb-1">{t('contact.supportLabel')}</h3>
              <a href="mailto:support@turgo.io" className="text-sm text-primary hover:underline">
                support@turgo.io
              </a>
            </div>
          </div>
