...
export function EditListingClient({
  ...
  const parseAddress = (addr: string) => {
    ...
    const street = remaining.length > 1 ? remaining.slice(0, -1).join(', ') : '';
      ...
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-0.5 text-[11px] text-muted-foreground">{title.length}/200</p>
              </div>
          ...
          <section>
            ...
            <div className="mt-3">
              ...
              <Input
                ...
                className="mt-1"
              />
              <p className="mt-0.5 text-[11px] text-muted-foreground">{t('addressHint')}</p>
            </div>
          </section>
          ...
          <div className="flex flex-col gap-3 border-t pt-6 sm:flex-row sm:justify-between">
            ...
            <Button onClick={handleSubmit} disabled={updateMutation.isPending} className="gap-1.5">
          ...
          {errors.submit && (
            <div className="rounded-lg border border-red-200 bg-red-50 dark:bg-red-950/20 p-4 text-center">
              <p className="text-sm font-medium text-red-600 dark:text-red-400">{errors.submit}</p>
            </div>
          )}
        </div>
      </div>
