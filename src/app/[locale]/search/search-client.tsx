...
export function SearchPageClient({
  ...
  const [viewMode, setViewMode] = useState<ViewMode>((filters.view as ViewMode) || 'grid');
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border">
      ...
      <div className="relative h-[450px] w-full bg-muted">
        <LeafletMapInner listings={listings} center={center} onMarkerClick={setSelectedId} />
      </div>
      ...
      <CardContent className="flex flex-col items-center gap-4 p-6 sm:flex-row">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            Set your criteria and our buying agent will monitor 24/7, alert you on great deals, and
