...
import { Bot, TrendingUp, Zap, Eye, MessageSquare, DollarSign, ShoppingBag } from 'lucide-react';
        ...
        {sellingAgents.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <h3 className="mb-2 text-lg font-semibold">{t('noSellingAgents')}</h3>
              <p className="text-muted-foreground">{t('noSellingAgentsDesc')}</p>
            </CardContent>
          </Card>
        ) : (
              ...
              <Card key={agent.id} className="overflow-hidden">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    <CardTitle className="line-clamp-1 text-base">{agent.listing.title}</CardTitle>
                    <Badge
                      variant={
                ...
                <CardContent className="space-y-3">
                  ...
                  {agent.actions.length > 0 && (
                    <div className="space-y-1 rounded-lg bg-muted p-3">
                      <p className="text-xs font-medium">{t('recentActivity')}</p>
                  ...
                  <div className="flex gap-2">
                    <Link href={`/listing/${agent.listing.slug}`} className="flex-1">
                      <Button variant="outline" size="sm" className="w-full">
                        {t('viewListing')}
                      </Button>
                    </Link>
                    <AgentStatusButton agentId={agent.id} initialStatus={agent.status} />
                  </div>
                </CardContent>
              </Card>
            ))}
        ...
        {buyingAgents.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <h3 className="mb-2 text-lg font-semibold">{t('noBuyingAgents')}</h3>
                ...
                <Card key={agent.id}>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {agent.matches.length > 0 && (
                      <div className="space-y-1 rounded-lg bg-muted p-3">
                        <p className="text-xs font-medium">{t('recentMatches')}</p>
