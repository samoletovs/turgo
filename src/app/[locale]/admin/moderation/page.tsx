...
export default function ModerationPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<'MODERATION' | 'REJECTED' | 'ACTIVE'>(
    'MODERATION',
  );
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Review and approve or reject listings</p>
      </div>
              ...
              <CardContent className="p-4">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-medium mt-1">&euro;{listing.price.toFixed(2)}</p>
                    {listing.location && (
