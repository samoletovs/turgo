          ...
          {activeTab === 'data' && (
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <label className="flex items-center justify-between gap-4 cursor-pointer">
                    <div>
                      <p className="text-sm font-medium">{t('data.marketingOptIn')}</p>
                      <p className="text-xs text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-4 text-sm text-muted-foreground">{t('data.exportDesc')}</p>
              ...
              <Card className="border-destructive">
                ...
                <CardContent>
                  <p className="mb-4 text-sm text-muted-foreground">{t('data.deleteDesc')}</p>
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>{t('data.deleteConfirm')}</DialogDescription>
                      </DialogHeader>
                      <div className="space-y-2">
