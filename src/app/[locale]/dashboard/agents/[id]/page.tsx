              ...
              {isSelling && (
                <>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <Badge
                      variant={sellingAgent!.autoRespond ? 'default' : 'secondary'}
                      className="text-xs"
                    >
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <Badge
                      variant={sellingAgent!.autoNegotiate ? 'default' : 'secondary'}
                      className="text-xs"
                    >
                    ...
                    <div key={day}>
                      ...
                      <div className="ml-4 space-y-0">
                        {(actions as typeof agentActions).map((action, i) => {
                          ...
                          const colorClass =
                            actionColorMap[action.actionType] || 'text-gray-500 bg-gray-500/10';
