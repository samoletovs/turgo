...
export default function OnboardingPage() {
  ...
  const steps = [
    ...
    <div key="0" className="text-center space-y-4">
      ...
      <p className="text-muted-foreground max-w-md mx-auto">{t('welcome.subtitle')}</p>
    </div>,
        ...
        {COUNTRIES.map((country) => (
          <button
            ...
            className={cn(
              ...
              selectedCountry === country.code ? 'border-primary bg-primary/5' : 'border-muted',
            )}
          >
            <span className="text-3xl">{country.flag}</span>
            <p className="mt-2 text-sm font-medium">{tRegion(country.name)}</p>
          </button>
        ))}
      </div>
    </div>,
        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={cn(
              ...
              selectedCategories.includes(cat) ? 'border-primary bg-primary/5' : 'border-muted',
            )}
          >
        ...
        {USE_CASES.map(({ id, icon: Icon }) => (
          <button
            ...
            className={cn(
              ...
              selectedUseCase === id ? 'border-primary bg-primary/5' : 'border-muted',
            )}
          >
    ...
    <div key="4" className="text-center space-y-4">
      ...
      <p className="text-muted-foreground max-w-md mx-auto">{t('step4.subtitle')}</p>
